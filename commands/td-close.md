...
# Step 5 — Validate PROJECT.md against reality
...
# Step 6 — Validate WORKWAY.md against reality
...
# Step 9 — Prune STATE.md to "closed" shape
...
If nothing changed in Steps 5–9, skip this commit (don't make empty commits).
...
**One sentence summary line:** `Closed. <N> commits pushed. <.td/ prune summary>.`
