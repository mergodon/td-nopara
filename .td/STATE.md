...
Blocker:  none
Last:     2026-05-04 — v3.4 shipped: bypassed rituals made explicit ("lets do it" trigger, Before-I-commit bundle, /init never-run warning). Pre-ship checklist passing retroactively.
